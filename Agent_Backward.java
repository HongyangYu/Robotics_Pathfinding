...
public class Agent_Backward{
	...
	public Agent_Backward(){
	 ...
	 //@@
	 private boolean goalTest2(State s){
		 return s.equalTo(cs);
	 }	 
	 
	 public boolean computePath(){
		 while(!goalTest2(OpenHeap.findMin())){ //@@
...
//		 System.out.print((cs.getCx() + 1) + "," + (cs.getCy() + 1) + "   ");
	 }
